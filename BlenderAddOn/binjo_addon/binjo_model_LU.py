...
map_model_lookup = {
    ...
    "(0x48) RBB - Machine Room":                  (0x7F25C8, 0x10428),
    "(0x49) MISSING":                             (0x000000, 0x10430),
    ...
    "(0xA8) GL - Floor 3 - BGS Entrance B":       (0xD1ADF8, 0x10718),
    "(0xA9) GL - Floor 4 - TTC Entrance B":       (0xD1DDE8, 0x10720),
